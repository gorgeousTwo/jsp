        ...
        <div class="card-body">
            <form action="#" method="post" role="form" data-toggle="validator">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control item" name="enterId" id="enterId" minlength="3" maxlength="10"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" data-error="You must have a Name" id="enterName" name="enterName"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="enterBirthday" id="enterBirthday" class="form-control" maxlength="10" required
